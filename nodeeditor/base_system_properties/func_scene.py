...
from nodeeditor.base_system_properties.graphical_scene import DrawGraphicalScene
from nodeeditor.base_nodes.func_node import AllNodeFunctions
from nodeeditor.base_edges.func_edge import AllEdgeFunctions
from nodeeditor.base_system_properties.func_scene_history import AllSceneHistoryFunctions
from nodeeditor.base_system_properties.func_scene_clipboard import AllSceneClipboardFunctions
...
class AllSceneFunctions(Serializable):
    ...
    def addNode(self, node: AllNodeFunctions):
        ...
        :type node: :class:`~nodeeditor.func_node.Node`
        """
