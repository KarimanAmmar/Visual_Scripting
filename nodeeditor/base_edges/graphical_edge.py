...
from nodeeditor.base_edges.graphical_edge_types import GraphicsEdgePathBezier, GraphicsEdgePathDirect, GraphicsEdgePathSquareLine
...
class DrawGraphicalEdge(QGraphicsPathItem):
    ...
    def __init__(self, edge:'Edge', parent:QWidget=None):
        ...
        :type edge: :class:`~nodeeditor.func_edge.Edge`
    ...
    def determineEdgePathClass(self):
        ...
        from nodeeditor.base_edges.func_edge import EDGE_TYPE_BEZIER, EDGE_TYPE_DIRECT, EDGE_TYPE_SQUARE
