...
from examples.DataScience.datascience_conf import register_node, OP_NODE_PIVOT
...
class DataScienceNodePivot(DataScienceNode):
    ...
    def evaluationOperation(self, input1, **kwargs):
        ...
        df_Pivot = dataframe.pivot(index=dataframe.columns[index1], columns=dataframe.columns[index2])
